            ...
            <div className="container-2 cont2pageaccount w-container">
                <div className="div-block-13">
                    <div className="card cardpageaccount"><img src="images/coin.png" loading="lazy" width="74" height="70" alt="" className="image-3" /><img src="images/Arrow.png" loading="lazy" alt="" className="image account-positionning" />
                        ...
                        <div className="text-block-33">$ 225.00</div>
                        ...
                        <div className="div-block-30">
                            ...
                            <div className="div-block-32">
                                <div className="text-block-31">$ 120.00</div><img src="images/next.png" loading="lazy" width="25" height="25" alt="" />
                            </div>
                        </div>
                        <div className="div-block-30">
                            ...
                            <div className="div-block-32">
                                <div className="text-block-31">$ 105.00</div><img src="images/next.png" loading="lazy" width="25" height="25" alt="" />
                            </div>
                        </div>
                        <div className="div-block-30">
