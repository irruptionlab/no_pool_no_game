    ...
    return (
        <div className="wf-section">
            <div className="div-block-33">
                ...
                <p className="paragraph-user-guide">All you need to use No Pool No Game on Ethereum Goerli is a crypto wallet, ETH for gas fees, and USDC to deposit into the protocol.
                </p>
                ...
                <p className="paragraph-user-guide">Using No Pool No Game is simple! First, make sure you are on the Ethereum Goerli network. Enter the amount of USDC you want to deposit and click on <strong>Review deposit</strong>.</p>
