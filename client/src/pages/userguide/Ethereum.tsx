        ...
        <div className="wf-section">
            <div className="div-block-33">
                <div className="div-block-34">
                    <h1>No Pool No Game on Ethereum Goerli </h1><img src="../../images/ethereum-eth-logo.png" loading="lazy" width="62" srcSet="../../images/ethereum-eth-logo-p-500.png 500w, ../../images/ethereum-eth-logo-p-800.png 800w, ../../images/ethereum-eth-logo-p-1080.png 1080w, ../../images/ethereum-eth-logo-p-1600.png 1600w, ../../images/ethereum-eth-logo-p-2000.png 2000w, ../../images/ethereum-eth-logo-p-2600.png 2600w, ../../images/ethereum-eth-logo-p-3200.png 3200w" sizes="(max-width: 479px) 100vw, (max-width: 767px) 8vw, (max-width: 991px) 7vw, 61.99622344970703px" alt="" className="image-13" />
                </div>
                <p className="paragraph-user-guide">All you need to use No Pool No Game on Ethereum is a crypto wallet, ETH for gas fees, and USDC to deposit into the protocol.
                </p>
                <h2>Adding Ethereum to your wallet</h2>
                <p className="paragraph-user-guide">In case you are using Metamask: The easiest way to add Ethereum to your wallet is by using <a href="https://chainlist.org/chain/1" target="_blank" rel="noreferrer" className="link-25">Chainlist</a>. Simply connect your wallet and tap on “Add to Metamask”.</p>
                <h2>How to Deposit</h2>
                <p className="paragraph-user-guide">Head to the Deposit tab in the No Pool No Game App or <a href="/" className="link-18" >follow this link</a>.</p>
                <h6><strong>Step 1: Check the network &amp; enter your deposit amount</strong></h6>
                <p className="paragraph-user-guide">Using No Pool No Game is simple! First, make sure you are on the Ethereum network. Enter the amount of USDC you want to deposit and click on <strong>Review deposit</strong>.</p>
                ...
                <p className="paragraph-user-guide">Now that you have a No Pool No Game deposit, you can check what prizes you won on the <a href="/account" className="link-20">Account</a> tab of the No Pool No Game App. </p>
