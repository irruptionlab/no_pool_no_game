    ...
    return (
        <div className="wf-section">
            <div className="div-block-33">
                ...
                <p className="paragraph-user-guide">In case you are using Metamask: The easiest way to add Ethereum to your wallet is by using <a href="https://chainlist.org/chain/1" className="link-25">Chainlist</a>. Simply connect your wallet and tap on “Add to Metamask”.</p>
