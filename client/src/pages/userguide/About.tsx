    ...
    return (
        <div className="wf-section">
            <div className="div-block-33">
                ...
                <p className="paragraph-user-guide">Every depositor has the same chance to win the contest, as it&#x27;s only based on your ability to be ranked within the best scores of the day, but the reward you will get is also correlated to the amount you have deposited. The more you save, the higher is your reward when you win a prize ! The difference between No Pool No Game and other prize savings protocols such as lottery, is that our model is based on the competence, not on luck. Everyone can make the difference.<br /><br />No Pool No Game is the only GameFi where you can earn money without taking the risk of loosing any ! </p>
                ...
                <h2>No Pool No Game is</h2>
                <p className="paragraph-user-guide">No Pool No Game is a Prize Linked Savings account powered by the blockchain. It&#x27;s:</p>
                <h4>Provably fair</h4>
                <p className="paragraph-user-guide">Prizes at No Pool No Game are transparent: anyone can confirm who won, when, and why.</p>
