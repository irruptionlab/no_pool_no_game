...
(function (SiweErrorType) {
    ...
    SiweErrorType["DOMAIN_MISMATCH"] = "Domain do not match provided domain for verification.";
    /** `nonce` don't match the nonce provided for verification. */
    SiweErrorType["NONCE_MISMATCH"] = "Nonce do not match provided nonce for verification.";
    ...
    SiweErrorType["INVALID_SIGNATURE"] = "Signature do not match address of the message.";
